...
const printNotesCode = `                          {/* 6. Statement */}
                          <div className="grid grid-cols-4">
                            <div className="col-span-1 bg-gray-50 px-4 py-2.5 font-bold border-l border-gray-300 text-gray-800">البيان والملاحظات:</div>
                            <div className="col-span-3 px-4 py-2.5 text-gray-900 font-semibold text-sm leading-relaxed">
                              {voucherNotes || 'لا يوجد ملاحظات إضافية'}
                            </div>
                          </div>`;

const newPrintNotesCode = `                          {/* 6. Statement */}
                          <div className="grid grid-cols-4">
                            <div className="col-span-1 bg-gray-50 px-4 py-2.5 font-bold border-l border-gray-300 text-gray-800">البيان والملاحظات:</div>
                            <div className="col-span-3 px-4 py-2.5 text-gray-900 font-semibold text-sm leading-relaxed">
                              {(() => {
...
if (code.includes('البيان والملاحظات:')) {
